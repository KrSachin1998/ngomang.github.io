 <div class="sidebar-menu">
    <header class="logo">
        <a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="dashboard.php"> <span id="logo"> <h1>NGO</h1></span> 
        ...
        <ul id="menu" >
            ...
            <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Services</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
					...
					<li id="menu-academico-avaliacoes" ><a href="add-services.php"> Add Website</a></li>
					<li id="menu-academico-avaliacoes" ><a href="add-services.php"> Add Logo</a></li>
					<li id="menu-academico-avaliacoes" ><a href="add-services.php"> Add Brochure</a></li>
					<li id="menu-academico-avaliacoes" ><a href="add-services.php"> Add Banner</a></li>
					<li id="menu-academico-avaliacoes" ><a href="add-services.php"> Add Letterhead</a></li>
